...
class ReviewKind(StrEnum):
    ...
    LLM_HIGHER_TIER = "llm_higher_tier"  # slice 6: the advisory LLM judged it more sensitive
...
class ClassificationVerdict:
    ...
    stage failed closed and forced the tier to CLASSIFIED.
    """
    ...
    def redacted(self) -> ClassificationVerdict:
        """Return a copy with both sub-verdicts' raw spans masked — safe for logs."""
        return replace(
            self,
