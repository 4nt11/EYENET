...
from eyenet.contracts.attribution import SUBJECT_LINKAGE_SUSPECTED, LinkageSuspectedEnvelope
...
async def linkages_suspect(
    ...
    return await decide_linkage(
        ...
        body=body,
        decision="suspected",
        subject=SUBJECT_LINKAGE_SUSPECTED,
        envelope_cls=LinkageSuspectedEnvelope,
        storage=storage,
        audit=audit,
        publisher=publisher,
