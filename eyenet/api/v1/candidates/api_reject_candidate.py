...
"""POST /v1/candidates/{candidate_id}/reject — queued -> rejected (M9.D3)."""
...
from eyenet.api.v1.schemas.candidates import CandidateDetail, RejectCandidateRequest
...
@router.post(
    ...
    operation_id="candidates_reject",
    response_model=CandidateDetail,
    status_code=202,
)
async def candidates_reject(
    candidate_id: UUID,
    ...
    await audit.emit(
        event="eyenet.audit.candidate.rejected",
